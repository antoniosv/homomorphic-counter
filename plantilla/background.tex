...
Having explained the residue and modulo operation, a very convenient notation, called the set of residues, can be introduced. Let $Z_{n}$ denote the set of nonnegative integers less than $n$:
\begin{equation}
Z_{n} = \{0,1,\cdots, (n-1)\}
\end{equation} 
