...
\begin{figure}[H]
  ...
  \centering
  \includegraphics{basiccryptosystem}
...
What this means is that a homomorphism serves as a link to translate operations from one group to the other, retaining its properties.
...
\emph{Partially homomorphic encryption} schemes are defined over a group, and they support one operation at most: either addition or multiplication. On the other hand, \emph{fully homomorphic encryption} schemes are defined over a ring, and can support up to two operations: addition and multiplication. The \emph{somewhat homomorphic encryption} schemes are akin to the fully homomorphic encryption schemes, in the sense that they can support up to two operations; however, the number of operations that can be performed is limited.
...
\begin{figure}[H]
  \centerline{\includegraphics{rot13remade}}
  \caption[Example of the homomorphic property in ROT13]{Example of the homomorphic property in ROT13. Based on Stuntz \cite{stuntz2010}.}
