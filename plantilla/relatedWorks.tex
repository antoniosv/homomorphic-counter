...
In essense, table \ref{tbl:comparison} compares the related works with each other, including this very thesis work, using a list of characteristics that are thought to be relevant in the context of secure computation in the cloud. 
...
Client-server architecture                                                    & $\times$                                                                             & $\times$                                                                             & $\bigcirc$                                                                            & $\bigtriangleup$                               & $\bigcirc$                                                                             & $\times$                                                                                 & $\bigcirc$                                \\ \hline
Cloud computation                                                             & $\bigcirc$                                                                             & $\times$                                                                             & $\bigcirc$                                                                            & $\bigcirc$                                & $\bigcirc$                                                                             & $\times$                                                                                 & $\bigcirc$                                \\ \hline
Real-world application                                                        & $\bigcirc$                                                                             & $\times$                                                                             & $\bigcirc$                                                                            & $\bigcirc$                                & $\times$                                                                             & $\bigcirc$                                                                                 & $\bigcirc$                                \\ \hline
Secure computation                                                            & $\bigcirc$                                                                             & $\bigcirc$                                                                             & $\bigcirc$                                                                            & $\bigcirc$                                & $\bigcirc$                                                                             & $\bigcirc$                                                                                 & $\bigcirc$                                \\ \hline
\begin{tabular}[c]{@{}l@{}}Homomorphic addition \\ support\end{tabular}       & $\bigcirc$                                                                             & $\times$                                                                             & $\bigcirc$                                                                            & $\times$                                & $\times$                                                                             & $\times$                                                                                 & $\bigcirc$                                \\ \hline
\begin{tabular}[c]{@{}l@{}}Homomorphic multiplication \\ support\end{tabular} & $\bigcirc$                                                                             & $\times$                                                                             & $\times$                                                                            & $\times$                                & $\times$                                                                             & $\times$                                                                                 & $\bigcirc$                                \\ \hline
Doesn't trust 3rd party                                                       & $\times$                                                                             & $\bigcirc$                                                                             & $\bigcirc$                                                                            & $\bigcirc$                                & $\bigcirc$                                                                             & $\times$                                                                                 & $\bigcirc$                                \\ \hline
